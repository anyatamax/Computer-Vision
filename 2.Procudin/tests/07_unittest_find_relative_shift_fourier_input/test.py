...
def test(kind, crop):
    ...
    for ai in [r_im, g_im, b_im]:
        pr_a_to_a = align.find_relative_shift_fourier(ai, ai)
    ...
    for bi, gt_b in [
        ...
        gt_a_to_b = gt_b - gt_a
        pr_a_to_b = align.find_relative_shift_fourier(ai, bi)
        ...
        gt_b_to_a = gt_a - gt_b
        pr_b_to_a = align.find_relative_shift_fourier(bi, ai)
