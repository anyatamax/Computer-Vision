...
def test_inverse_dct_1():
    ...
    answer = ic.inverse_dct(
        ic.inverse_quantization(
            ic.quantization(ic.dct(block_1), y_quantization_matrix),
            y_quantization_matrix,
        )
    )
...
def test_inverse_dct_2():
    ...
    answer = ic.inverse_dct(
        ic.inverse_quantization(
            ic.quantization(ic.dct(block_2), color_quantization_matrix),
            color_quantization_matrix,
        )
    )
    true_answer = np.array(
        [
